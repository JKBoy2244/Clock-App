...
- Note: In terms of finding all the cities for each country, I used the internet a lot to be honest when doing some huge research and used websites like wikipedia to generate an array per country regarding all the cities within that particular country. Hopefully, everything is covered though.
